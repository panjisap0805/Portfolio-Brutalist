export default function ProjectImpact({ csatScore, csatSubtitle, efficiencyGain, efficiencySubtitle, constraintsText }) {
  return (
    <div className="p-6 md:p-16 bg-white min-h-[500px]">
