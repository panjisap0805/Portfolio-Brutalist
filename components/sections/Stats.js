  ...
  return (
    <section className="border-b-2 border-black bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="p-8 border-b-2 md:border-b-0 lg:border-r-2 border-black hover:bg-gray-50 transition-colors group">
        ...
        <div className="p-8 border-b-2 md:border-b-0 md:border-r-2 lg:border-t-2 border-black hover:bg-gray-50 transition-colors group">
          ...
          <div className="text-5xl lg:text-6xl font-bold text-black mb-2 group-hover:text-primary transition-colors">12+</div>
