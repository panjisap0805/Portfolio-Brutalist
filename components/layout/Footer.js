      ...
      <div className="relative z-10 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t-2 border-white/20 pt-12">
          <div>
            ...
            <a className="text-2xl lg:text-3xl font-bold hover:text-primary transition-colors block mb-2" href="mailto:panji@email.com">panji@email.com</a>
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="flex gap-6">
                <a className="text-xl font-bold hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary" href="#">LinkedIn</a>
                <a className="text-xl font-bold hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary" href="#">Dribbble</a>
                <a className="text-xl font-bold hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary" href="#">Medium</a>
              </div>
            </div>
            <div className="mt-12 md:mt-0 text-right">
              <p className="font-mono text-xs text-gray-500">© 2023 PANJI SAPUTRO. BRUTALIST PORTFOLIO V1.0</p>
            </div>
          </div>
        </div>
      </div>
